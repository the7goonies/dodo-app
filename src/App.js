...
const App = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch('https://api.streamelements.com/kappa/v2/activities/59b478950d3fde75addb52b9?limit=5000&mincheer=1&minhost=1&minsub=1&mintip=0&origin=0&types=subscriber', {
        headers: {
